...
use crate::cpp_postprocessor::{CppPostprocessor, EncounteredType, EncounteredTypeKind};
use crate::TypeName;
...
impl<'a> BridgeConverter<'a> {
    ...
    /// suitable for cxx.
    pub(crate) fn convert(&mut self, bindings: ItemMod) -> Result<Vec<Item>, ConvertError> {
                    ...
                    match item {
                        ...
                        Item::Struct(s) => {
                            ...
                            if should_be_pod {
                                ...
                                self.disable_type(EncounteredType(
                        ...
                        Item::Enum(e) => {
                            ...
                            let tyname = TypeName::from_ident(&tyident);
                            self.disable_type(EncounteredType(EncounteredTypeKind::Enum, tyname));
