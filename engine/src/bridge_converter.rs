...
use syn::{
    parse::Parser, parse_quote, Attribute, Field, FnArg, ForeignItem, ForeignItemFn, GenericParam,
    Generics, Ident, Item, ItemForeignMod, ItemMod, ItemStruct, Pat, ReturnType, Type, TypePtr,
};
