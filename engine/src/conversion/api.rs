...
pub(crate) struct Api<T: ApiAnalysis> {
    ...
    /// Whether we should generate any C++ for this API, beyond that
    /// which is generated by cxx. This could be replaced with a
    /// `get_cpp_need` associated function which dynamically generates this.
    /// TODO.
