    ...
    pub(crate) fn convert(
        ...
        match &mut bindgen_mod.content {
            ...
            Some((_, items)) => {
                ...
                let conversion = BridgeConversion::new(byvalue_checker, &self.type_database);
                let parse_results = conversion.convert_items(items_in_root, exclude_utilities)?;
