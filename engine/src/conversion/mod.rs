...
use analysis::function::analyze_functions;
...
use self::{analysis::{ctypes::append_ctype_information, gc::filter_apis_by_following_edges_from_allowlist, pod::{analyze_pod_apis, identify_byvalue_safe_types}}, codegen_rs::RsCodeGenerator, parse::ParseBindgen};
    ...
    pub(crate) fn convert(
        ...
        match &mut bindgen_mod.content {
            ...
            Some((_, items)) => {
                ...
                append_ctype_information(&mut analyzed_apis);
